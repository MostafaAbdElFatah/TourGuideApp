...
public class TouristPlacesFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        String[] parksNames = getResources().getStringArray(R.array.tourist_places_names);
        String[] parksDesc = getResources().getStringArray(R.array.tourist_places_description);
        TypedArray images = getResources().obtainTypedArray(R.array.tourist_places_images);
        ...
        PlaceAdapter adapter = new PlaceAdapter(getActivity(), places, R.color.category_Tourist_places);
