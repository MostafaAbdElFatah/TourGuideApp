...
public class HotelsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        String[] parksNames = getResources().getStringArray(R.array.hotel_names);
        String[] parksDesc = getResources().getStringArray(R.array.hotel_descriptions);
        TypedArray images = getResources().obtainTypedArray(R.array.hotel_images);
        ...
        PlaceAdapter adapter = new PlaceAdapter(getActivity(), places, R.color.category_Hotel);
