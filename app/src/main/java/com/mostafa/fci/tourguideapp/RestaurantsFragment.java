...
public class RestaurantsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        String[] parksNames = getResources().getStringArray(R.array.resturants_names);
        String[] parksDesc = getResources().getStringArray(R.array.resturants_address);
        TypedArray images = getResources().obtainTypedArray(R.array.resturants_images);
